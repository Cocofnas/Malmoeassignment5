namespace Malmoinl5
{
    public partial class MainForm : Form
    {
        ...
        private void DisplayCustomerDetails(Customer customer)
        {
            ...
            listView1.Items.Add(new ListViewItem(new[] { "Private", customer.ContactDetails.Email.PrivateEmail }, emailGroup));
            listView1.Items.Add(new ListViewItem(new[] { "Office", customer.ContactDetails.Email.BusinessEmail }, emailGroup));
